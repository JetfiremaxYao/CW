    ...
    with open(file_path, 'rb') as fid:
        for block_index in range(json_data2[FIELD_TOTAL_BLOCK]):
            ...
            if block_size * (block_index + 1) < file_size:
                ...
                print("key: ",json_data3[FIELD_KEY],", ",
                      "block_index: ",json_data3[FIELD_BLOCK_INDEX],", ",
                      "operation: ",json_data3[FIELD_OPERATION],", ",
                      "direction: ",json_data3[FIELD_DIRECTION],", ",
                      "status: ", json_data3[FIELD_STATUS], ", ",
                      "status_msg", json_data3[FIELD_STATUS_MSG]
                      )
            else:
                ...
                print("key: ", json_data3[FIELD_KEY], ", ",
                      "block_index: ", json_data3[FIELD_BLOCK_INDEX], ", ",
                      "md5: ", json_data3[FIELD_MD5], ", ",
                      "operation: ", json_data3[FIELD_OPERATION], ", ",
                      "direction: ", json_data3[FIELD_DIRECTION], ", ",
                      "status: ", json_data3[FIELD_STATUS], ", ",
                      "status_msg", json_data3[FIELD_STATUS_MSG],", "
                      "type", json_data3[FIELD_TYPE], ", "
                      )
